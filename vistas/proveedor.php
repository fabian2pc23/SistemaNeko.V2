            ...
            <div class="neko-card__body panel-body table-responsive" id="listadoregistros">
              ...
              <div class="kpi-container">
                ...
                <div class="kpi-card kpi-card--primary" onclick="mostrarDetalleKPI('total')" style="cursor:pointer;">
                  <div class="kpi-card__title">Total Proveedores <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <div class="kpi-card kpi-card--success" style="cursor:pointer;">
                  <div class="kpi-card__title">Estado Proveedores <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__dual">
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('activos')">
                    ...
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('inactivos')">
                ...
                <!-- 3. Proveedor Top -->
                <div class="kpi-card kpi-card--purple" onclick="mostrarDetalleKPI('top')" style="cursor:pointer;">
                  <div class="kpi-card__title">Proveedor Destacado <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__header">
                    <div>
