...
?>
  ...
  <style>
    ...
    @media (max-width: 768px) {
      ...
      .neko-actions .btn-group {
        display: flex;
        flex-direction: column;
        width: 100%;
      }

      .neko-actions .btn-group .btn {
          ...
          <div class="neko-card">
            ...
            <div class="neko-card__body panel-body table-responsive" id="listadoregistros">
              ...
              <div class="kpi-container">
                <!-- 1. Compras Hoy -->
                <div class="kpi-card kpi-card--primary" onclick="mostrarDetalleKPI('hoy')" style="cursor:pointer;">
                  <div class="kpi-card__title">Compras Hoy <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <!-- 2. Compras Mes -->
                <div class="kpi-card kpi-card--info" onclick="mostrarDetalleKPI('mes')" style="cursor:pointer;">
                  <div class="kpi-card__title">Compras Mes <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__header">
                    <div>
                ...
                <!-- 3. Total Histórico -->
                <div class="kpi-card kpi-card--purple" onclick="mostrarDetalleKPI('historico')" style="cursor:pointer;">
                  <div class="kpi-card__title">Total Histórico <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__header">
                    <div>
                ...
                <div class="kpi-card kpi-card--success" style="cursor:pointer;">
                  <div class="kpi-card__title">Estado Ingresos <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__dual">
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('aceptados')">
                    ...
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('anulados')">
