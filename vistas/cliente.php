              ...
              <div class="kpi-container">
                ...
                <div class="kpi-card kpi-blue" onclick="mostrarDetalleKPI('total')" style="cursor:pointer;">
                  <div class="kpi-card__header">
                    <div class="kpi-card__title">Total Clientes <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <div class="kpi-card kpi-red" onclick="mostrarDetalleKPI('inactivos')" style="cursor:pointer;">
                  <div class="kpi-card__header">
                    <div class="kpi-card__title">Inactivos <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
              ...
              <form name="formulario" id="formulario" method="POST">
                ...
                <div class="row">
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <small class="text-muted">DNI (8 dígitos) o RUC (11 dígitos).</small>
                  </div>
