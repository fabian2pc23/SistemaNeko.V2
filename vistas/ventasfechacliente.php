...
<style>
  ...
  .neko-card__header {
    background: #0d47a1; /* Blue header from image */
    color: #fff;
    padding: 15px 25px;
  ...
  .neko-card__title i { color: #fff; }
  .neko-card__body { padding: 25px; background: #fdfdfd; }
  ...
  .kpi-card:hover { transform: translateY(-3px); box-shadow: 0 8px 16px rgba(0,0,0,0.1); }
  
  .kpi-content { display: flex; flex-direction: column; justify-content: center; }
  .kpi-label { font-size: 0.8rem; font-weight: 500; color: #697a8d; margin-bottom: 5px; }
  .kpi-value { font-size: 1.2rem; font-weight: 700; color: #364152; margin: 0; }
  
  .kpi-icon-box {
    width: 45px; height: 45px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.2rem;
  }
  /* Colores KPI */
  .kpi-blue .kpi-icon-box { background: #e3f2fd; color: #2196f3; }
  .kpi-green .kpi-icon-box { background: #e8f5e9; color: #4caf50; }
  .kpi-purple .kpi-icon-box { background: #f3e5f5; color: #9c27b0; }
  .kpi-orange .kpi-icon-box { background: #fff3e0; color: #ff9800; }
  .kpi-red .kpi-icon-box { background: #ffebee; color: #f44336; }
  ...
  /* Filtros */
  .filters-row{
    display:grid; grid-template-columns:1fr 1fr 1.5fr; gap:18px; margin-bottom:14px;
  }
  .filters-row label{ font-weight:600; color:#0b2752; display:block; margin-bottom:6px; }
  .filters-row .form-control{ height:40px; padding:6px 12px; border:1px solid #dbe3ef; border-radius:8px; background: #fff; }
  .bootstrap-select .dropdown-toggle { border-radius: 8px; border: 1px solid #dbe3ef; height: 40px; }
  ...
  .quick-filters .btn:hover, .quick-filters .btn.active {
    background: #e3f2fd;
    color: #1976d2;
    border-color: #bbdefb;
  }
