<?php
// vistas/categoria.php — Estilo corporativo moderno con KPIs
ob_start();
...
// Permiso (módulo almacen/categorías)
        ...
        <div class="col-md-12">
          ...
          <div class="neko-card">
            ...
            <div class="neko-card__header">
              <h1 class="neko-card__title"><i class="fa fa-tags"></i> Categorías</h1>
            ...
            <div class="neko-card__body" id="listadoregistros">
              ...
              <div class="kpi-container">
                <!-- Total Categorías -->
                <div class="kpi-card kpi-card--primary" onclick="mostrarDetalleKPI('total')" style="cursor:pointer;">
                  <div class="kpi-card__title">Total Categorías <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <div class="kpi-card kpi-card--success" style="cursor:pointer;">
                  <div class="kpi-card__title">Estado de Categorías <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__dual">
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('activas')">
                    ...
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('inactivas')">
                ...
                <!-- Sin Artículos -->
                <div class="kpi-card kpi-card--warning" onclick="mostrarDetalleKPI('sin_articulos')" style="cursor:pointer;">
                  <div class="kpi-card__title">Sin Artículos <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__header">
                    <div>
                ...
                <!-- Stock Crítico -->
                <div class="kpi-card kpi-card--danger" onclick="mostrarDetalleKPI('stock_critico')" style="cursor:pointer;">
                  <div class="kpi-card__title">Stock Crítico <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__header">
                    <div>
                ...
                <!-- Nuevas (30 días) -->
                <div class="kpi-card kpi-card--purple" onclick="mostrarDetalleKPI('nuevas')" style="cursor:pointer;">
                  <div class="kpi-card__title">Nuevas (30 días) <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                  <div class="kpi-card__header">
                    <div>
