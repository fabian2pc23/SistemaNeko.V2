            ...
            <div class="neko-card__body panel-body table-responsive" id="listadoregistros">
              ...
              <div class="kpi-container">
                ...
                <div class="kpi-card kpi-card--primary" onclick="mostrarDetalleKPI('total')" style="cursor:pointer;">
                  <div class="kpi-card__title">Total artículos <i class="fa fa-info-circle" style="font-size:0.7rem;opacity:0.6;"></i></div>
                ...
                <div class="kpi-card kpi-card--success">
                  <div class="kpi-card__title">Estado de artículos <i class="fa fa-info-circle" style="font-size:0.7rem;opacity:0.6;"></i></div>
                  <div class="kpi-card__dual">
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('activos')" style="cursor:pointer;">
                    ...
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('inactivos')" style="cursor:pointer;">
                ...
                <div class="kpi-card kpi-card--warning">
                  <div class="kpi-card__title">Gestión de stock <i class="fa fa-info-circle" style="font-size:0.7rem;opacity:0.6;"></i></div>
                  <div class="kpi-card__dual">
                    <div class="kpi-dual-item" onclick="mostrarDetalleKPI('con_stock')" style="cursor:pointer;">
                ...
                <div class="kpi-card kpi-card--danger" onclick="mostrarStockBajo()" style="cursor:pointer;">
                  <div class="kpi-card__title">Stock bajo (&lt; 5) <i class="fa fa-info-circle" style="font-size:0.7rem;opacity:0.6;"></i></div>
                  <div class="kpi-card__header">
                    <div>
                ...
                <!-- 5. Stock total -->
                <div class="kpi-card kpi-card--purple" onclick="mostrarDetalleKPI('stock_total')" style="cursor:pointer;">
                  <div class="kpi-card__title">Stock total <i class="fa fa-info-circle" style="font-size:0.7rem;opacity:0.6;"></i></div>
                  <div class="kpi-card__header">
                    <div>
