            ...
            <div class="neko-card__body" id="listadoregistros">
              ...
              <div class="kpi-container">
                ...
                <div class="kpi-card kpi-card--primary" onclick="mostrarDetalleKPI('total')" style="cursor: pointer;">
                  <div class="kpi-card__title">Total Marcas <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <div class="kpi-card kpi-card--success" style="cursor: pointer;">
                  <div class="kpi-card__title">Estado de Marcas <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <!-- Sin Artículos -->
                <div class="kpi-card kpi-card--warning" id="card-sin-articulos" onclick="mostrarDetalleKPI('sin_articulos')" style="cursor: pointer;">
                ...
                <!-- Stock Crítico -->
                <div class="kpi-card kpi-card--danger" id="card-stock-critico" onclick="mostrarDetalleKPI('stock_critico')" style="cursor: pointer;">
                ...
                <!-- Nuevas (30 días) -->
                <div class="kpi-card kpi-card--purple" id="card-nuevas" onclick="mostrarDetalleKPI('nuevas')" style="cursor: pointer;">
