...
?>
  ...
  <style>
    ...
    /* Botones de documentos electrónicos */
    #tbllistado td:first-child {
      white-space: nowrap;
    }

    #tbllistado td:first-child .btn {
      margin: 1px;
      padding: 4px 8px;
      font-size: 0.75rem;
      border-radius: 5px;
    ...
    #tbllistado td:first-child .btn:hover {
      transform: translateY(-1px);
      box-shadow: 0 3px 8px rgba(0, 0, 0, 0.2);
    }

    /* Tooltip para botones */
    #tbllistado td:first-child a[title],
    #tbllistado td:first-child button[title] {
      position: relative;
    }

    /* Estilos para columna de opciones más ancha */
          ...
          <div class="neko-card">
            ...
            <div class="neko-card__body panel-body" id="listadoregistros">
              ...
              <div class="kpi-container">
                <!-- 1. Ventas Hoy -->
                <div class="kpi-card kpi-green" onclick="mostrarDetalleKPI('hoy')" style="cursor:pointer;">
                  <div class="kpi-card__header">
                    <div class="kpi-card__title">Ventas Hoy <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <!-- 2. Ventas Mes -->
                <div class="kpi-card kpi-blue" onclick="mostrarDetalleKPI('mes')" style="cursor:pointer;">
                  <div class="kpi-card__header">
                    <div class="kpi-card__title">Ventas Mes <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <!-- 3. Ticket Promedio -->
                <div class="kpi-card kpi-orange" onclick="mostrarDetalleKPI('ticket')" style="cursor:pointer;">
                  <div class="kpi-card__header">
                    <div class="kpi-card__title">Ticket Promedio <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <!-- 4. Tasa Éxito -->
                <div class="kpi-card kpi-purple" onclick="mostrarDetalleKPI('tasa')" style="cursor:pointer;">
                  <div class="kpi-card__header">
                    <div class="kpi-card__title">Tasa de Éxito <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
                ...
                <!-- 5. Cliente Top -->
                <div class="kpi-card kpi-red" onclick="mostrarDetalleKPI('top')" style="cursor:pointer;">
                  <div class="kpi-card__header">
                    <div class="kpi-card__title">Cliente Destacado <i class="fa fa-info-circle" style="opacity:0.5;font-size:0.7rem;"></i></div>
