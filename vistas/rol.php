...
<style>
  ...
  .nk-permisos{
    background:#f8fafc; border:1px solid #e2e8f0; border-radius:10px; padding:16px; max-height:400px; overflow-y:auto;
  }
  .nk-ul-permisos{ list-style:none; padding:0; margin:0; }
  .nk-ul-permisos li{ padding:10px 12px; border-bottom:1px solid #e2e8f0; transition: background 0.2s ease; }
  .nk-ul-permisos li:last-child{ border-bottom:none; }
  .nk-ul-permisos li:hover{ background:#e3f2fd; }
  .nk-ul-permisos label{ display:flex; align-items:center; gap:10px; cursor:pointer; margin:0; font-weight:500; color:#334155; }
  .nk-ul-permisos input[type="checkbox"]{ width:18px; height:18px; cursor:pointer; }
          ...
          <div class="neko-card__body" id="listadoregistros">
            ...
            <div class="kpi-container">
              ...
              <div class="kpi-card kpi-green">
                <div class="kpi-card__header">
                  <div class="kpi-card__title">Roles Activos</div>
              ...
              <div class="kpi-card kpi-red">
                <div class="kpi-card__header">
                  <div class="kpi-card__title">Roles Inactivos</div>
